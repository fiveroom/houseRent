				...
				<section class="detail">
					<header :class="['detail-title',detailFiexd?'detail-title__fixed':'']">
						<ul class="detail-title-l">
							<li :class="detailIndex == 0?'detail-title-l--active':''" @click="detailIndex=0">房源简介</li>
							<li :class="detailIndex == 1?'detail-title-l--active':''" @click="detailIndex=1">租约信息</li>
							<li :class="detailIndex == 2?'detail-title-l--active':''" @click="detailIndex=2">周边配套</li>
