						...
						<ScrollBar :class="['msg-content', showRemind?'msg-content--show':'msg-content--leave']">
							<div>
								<div class="msgitem">
									<header>系统消息</header>
									<ul>
										<li class="msg-li msg-li-nomsg" :style="liAnima(0, 0)" v-if="sysRemind.TotalCount != 0">暂时没有消息</li>
										<li
											class="msg-li"
								...
								<div class="msgitem">
									<header>预约提醒</header>
									<ul>
										<li class="msg-li msg-li-nomsg" :style="liAnima(0, 0)" v-if="bsRemind.TotalCount != 0">暂时没有消息</li>
										<li
											class="msg-li"
											v-for="(item, index) in test"
											:key="index"
								...
								<div class="msgitem">
									<header>合同提醒</header>
									<ul>
										<li class="msg-li msg-li-nomsg" :style="liAnima(0, 0)" v-if="conRemind.TotalCount != 0">暂时没有消息</li>
										<li></li>
									</ul>
								</div>
								<div class="msgitem">
									...
									<ul>
										<li class="msg-li msg-li-nomsg" :style="liAnima(0, 0)" v-if="payRemind.TotalCount != 0">暂时没有消息</li>
									</ul>
								</div>
							</div>
						</ScrollBar>
