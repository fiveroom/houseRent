		...
		<section class="contract">
			...
			<div class="contract-box" ref="contract">
				...
				<ul class="con-body">
					<li v-for="item in contractList" :key="item.Con_id">
						<div class="con-body__img">
							...
							<div class="con-body__icon">
								...
								<i class="el-icon-download" @click="downloadCon(item.Con_path)"></i>
							</div>
						</div>
						<ul class="user-info">
							<li>
					...
					<li v-for="item in contractList" :key="item.Con_id + 2">
						...
						<ul>
							...
							<li>
								<div>租期</div>
								<p>
									<span>{{item.Con_startTime}}</span>
									<span>~</span>
									<span>{{item.Con_endTime}}</span>
								</p>
							</li>
							<li>
								<div>类型</div>
					...
					<li v-for="item in contractList" :key="item.Con_id + 4">
						<div>
							<img :src="item.Con_path" alt />
						</div>
						<ul>
